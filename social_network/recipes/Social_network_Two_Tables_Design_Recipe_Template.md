# {social_network} Two Tables Design Recipe
...
user account x, email address x, username x, user's posts x, post's title x, 
post's content x, post's number of views x
```
